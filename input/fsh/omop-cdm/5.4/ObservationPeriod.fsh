...
* person_id	1..1	Reference(OMOPPerson) "Person" "The Person ID of the PERSON record for which the Observation Period is recorded."
...
* period_type_concept_id	1..1	Reference(OMOPConcept)	"Period Type" "This field can be used to determine the provenance of the Observation Period as in whether the period was determined from an insurance enrollment file, EHR healthcare encounters, or other sources."
