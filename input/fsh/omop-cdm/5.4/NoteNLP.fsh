...
* note_id 1..1 Reference(OMOPNote) "Note" "This is the NOTE_ID for the NOTE record the NLP record is associated to."
* section_concept_id 0..1 Reference(OMOPConcept) "Section" ""
...
* note_nlp_concept_id 0..1 Reference(OMOPConcept) "Note NLP" ""
* note_nlp_source_concept_id 0..1 Reference(OMOPConcept)  "Note NLP Source" ""
